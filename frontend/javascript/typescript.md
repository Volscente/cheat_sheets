...
An interfaces is always used to defining the shape of an **Object**. It is a so called "TypeScript Contract". It can also be usd with functions, in order to define what a function must receive to function correctly.
