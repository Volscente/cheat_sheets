...
2. `docs/planning/planning_guidelines.md` — defines the spec format
...
**If type = spec**, produce a technical spec that follows the structure defined in `docs/planning/planning_guidelines.md` and uses `docs/planning/vdata-8417_mds_translation_evaluation/vdata-8860_implement-comet-da.md` as a style reference:
