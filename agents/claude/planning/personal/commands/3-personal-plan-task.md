...
**If type = initiative**, produce a planning document following `~/.claude/templates/personal_general_plan_template.md`:
...
**If type = spec**, populate `~/.claude/templates/personal_tech_spec_template.md`:
