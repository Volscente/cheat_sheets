...
| :--- | :--- | :--- | :--- |
| `--file` | Yes | Path to the filled `proposal.md` | `docs/rfc/recipe-app_add-search-bar/proposal.md` |
...
1. Copy `agents/claude/planning/personal/templates/rfc_proposal_template.md` to
   `docs/rfc/<project>_<title>/proposal.md`.
2. Fill out the YAML frontmatter and `## Problem` section.
3. Run `/create-rfc --file docs/rfc/<project>_<title>/proposal.md`.
...
Read `agents/claude/planning/personal/templates/rfc_template.md` — this is the canonical output structure.
