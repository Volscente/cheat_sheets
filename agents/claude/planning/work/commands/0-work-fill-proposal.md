...
- **Assumptions made** while inferring blank fields or drafting sections — anything you should double-check (e.g. an inferred team/org, a guessed milestone list, a scope-out reason you didn't state yourself).
