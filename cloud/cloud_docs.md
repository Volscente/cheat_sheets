...
## Regions and Zones
One way to deal with fault tolerance is to spread resources and compute capabilities across different regions and zones. In this way, even if a data center fails, other can be still available.